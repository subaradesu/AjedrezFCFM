...
INSERT INTO `tarea3grupo22`.`event` (`id_event`, `title`, `description`, `date_start`, `date_end`, `place`, `visibility`, `status`, `idCategory`) VALUES (2, 'Torneo Blitz Chacriento Numero 5', 'Vamos a jugar! Pequeño torneo a 3m+2s. Todos bienvenidos', '2015-10-20 16:00:00', '2015-10-20 18:00:00', 'Sala de juegos, Piso -3, Baeauchef 851.', 'public', 'ended', 2);
